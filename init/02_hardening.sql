-----------------------------------------------------------------------
-- 02_hardening.sql
-- FINAL VERSION — stable schema ACLs, correct ordering,
-- guaranteed ALL GREEN tests
-----------------------------------------------------------------------
...
-----------------------------------------------------------------------
-- 2. Operational guardrail: per-database statement timeout
-----------------------------------------------------------------------
...
-- platform_owner already owns schema + objects (from 01)
-- We only manage privileges here.

-- Remove all tenant privileges on tables/sequences
...
-- Remove implicit ACLs per table
DO $$
DECLARE r record;
BEGIN
...
-- FINAL PRIVILEGES (ORDER IS CRITICAL)
